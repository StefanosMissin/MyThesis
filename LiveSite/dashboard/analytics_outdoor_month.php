...
?>
    ...
    <?php
            $navloctitle = 'Analytics Outdoor Last Month';
        ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        for ($i = 0; $i < 30; $i++) {
                                            echo "<tr>";
                                            $ANdate = "SELECT date AS DATET FROM `outdoor_data` WHERE date = (CURRENT_DATE - INTERVAL $i DAY) LIMIT 1";
                                                ...
                                                while($row = $result_date->fetch_assoc()) {
                                                    ...
                                                    if ($result_temperaturemax->num_rows > 0 ) 
                                                    {
                                                        while($row = $result_temperaturemax->fetch_assoc()) {
                                                            ...
                                                            $ANtempmin = "SELECT min(temperature) AS MINT FROM `outdoor_data` WHERE date = (CURRENT_DATE - INTERVAL $i DAY)";
                                                            ...
                                                            if ($result_temperaturemin->num_rows > 0 ) 
                                                            {
                                                                while($row = $result_temperaturemin->fetch_assoc()) {
                                                                    ...
                                                                    $ANtempavg = "SELECT cast((AVG(temperature)) as decimal(16,2)) AS AVGT FROM `outdoor_data` WHERE date = (CURRENT_DATE - INTERVAL $i DAY)";
                                    ...
                                    <?php
                                        ...
                                        for ($i = 0; $i < 30; $i++) {
                                            ...
                                            if ($result_date->num_rows > 0 ) 
                                            {
                                                while($row = $result_date->fetch_assoc()) {
                                                    echo "<td class='users-table-center'>" . $row["DATET"]. "</td>";
                                                    $ANhumimax = "SELECT max(humidity) AS MAXH FROM `outdoor_data` WHERE date = (CURRENT_DATE - INTERVAL $i DAY)";
                                                    ...
                                                    if ($result_humimax->num_rows > 0 ) 
                                                    {
                                                        while($row = $result_humimax->fetch_assoc()) {
                                                            ...
                                                            $ANhumimin = "SELECT min(humidity) AS MINH FROM `outdoor_data` WHERE date = (CURRENT_DATE - INTERVAL $i DAY)";
                                                            ...
                                                            if ($result_humimin->num_rows > 0 ) 
                                                            {
                                                                while($row = $result_humimin->fetch_assoc()) {
                                                                    ...
                                                                    $ANhumiavg = "SELECT cast((AVG(humidity)) as decimal(16,2)) AS AVGH FROM `outdoor_data` WHERE date = (CURRENT_DATE - INTERVAL $i DAY)";
